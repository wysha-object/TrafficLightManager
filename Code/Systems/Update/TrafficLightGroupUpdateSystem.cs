...
/**
 * 同一联动组的每个路口实体更新后,
 * 在TrafficLightGroupUpdateSystem里同步
 */
    ...
    protected override void OnUpdate()
    {
        ...
        JobChunkExtensions.ScheduleParallel(
            new UpdateTrafficLightGroupJob
            {
                ...
                m_ExtraLaneSignalLookup = GetComponentLookup<ExtraLaneSignal>(isReadOnly: true),
                m_LaneFlowLookup = GetComponentLookup<LaneFlow>(isReadOnly: true),
                m_LaneFlowHistoryLookup = GetComponentLookup<LaneFlowHistory>(isReadOnly: true),
                m_MasterLaneLookup = GetComponentLookup<MasterLane>(isReadOnly: true),
                m_CarLaneLookup = GetComponentLookup<CarLane>(isReadOnly: true),
                m_TrackLaneLookup = GetComponentLookup<TrackLane>(isReadOnly: true),
                m_PedestrianLaneLookup = GetComponentLookup<PedestrianLane>(isReadOnly: true),
